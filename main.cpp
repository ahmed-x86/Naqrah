...
public:
    explicit MainWindow(QWidget* parent = nullptr) : QWidget(parent) {
        ...
        // Install global event filter to dynamically detect input method
...
protected:
    ...
    bool eventFilter(QObject* obj, QEvent* event) override {
        ...
        // Detect Mouse Events
            ...
            // Ignore synthetic mouse events generated by the OS due to touch
...
private:
    void updateUIForInputMode(InputMode mode) {
        if (mode == InputMode::Touch) {
            // Touch Mode: Enable kinetic scrolling, larger paddings/margins for fat fingers
            if (m_scrollArea) {
            ...
            // Desktop Mode: Disable kinetic scrolling (use wheel), tighter layout for precise cursor
            if (m_scrollArea) {
